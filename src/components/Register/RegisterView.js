        ...
        <div className="container mb-5">
            ...
            <div className="card mx-auto mt-5 pb-3 shadow rounded" style={{ width: "25rem" }} >
                <div className="card-body">
                    <h4 className={`card-title text-success text-center ${rtl}`}>{t('register.title')}</h4>
                    ...
                    <form className="needs-validation" onSubmit={props.handleSubmit} autocomplete="off" noValidate >
                        ...
                        <div className="form-group">
                            ...
                            <input type="email" name="email" className={`form-control ${rtl}`} placeholder="your_mail@gmail.com"
                                id="userEmail" aria-describedby="emailHelp" value={props.email} onChange={props.handleChange} required />
                            <small id="emailHelp" className={`form-text text-muted ${rtl}`}><i className="fas text-primary fa-info"></i>
                            {t('register.email_info')}</small>
                            <div className="valid-feedback">
                                <i className={`far text-success fa-thumbs-up ${rtl}`}></i> {t('validation.ok')}
                        </div>
                            <div className={`invalid-feedback ${rtl}`}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="password" className={`form-control ${rtl}`} placeholder="******" name="password"
                                id="userPassword" aria-describedby="passwordHelp" value={props.password} onChange={props.handleChange} required minLength="6" />
                            <small id="passwordHelp" className={`form-text text-muted ${rtl}`}><i className="fas text-primary fa-info"></i>
                            {t('register.password_info')}</small>
                            <div className={`valid-feedback ${rtl}`}>
                                <i className="far text-success fa-thumbs-up"></i> {t('validation.ok')}
                        </div>
                            <div className={`invalid-feedback ${rtl}`}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="password" className={`form-control ${rtl}`} placeholder="******" name="password2"
                                id="userPassword2" aria-describedby="passwordHelp2" value={props.password2} onChange={props.handleChange} required minLength="6" />
                            <small id="passwordHelp2" className={`form-text text-muted ${rtl}`}><i className="fas text-primary fa-info"></i>
                            {t('register.password2_info')}</small>
                            <div className={`valid-feedback ${rtl}`}>
                                <i className="far text-success fa-thumbs-up"></i> {t('validation.ok')}
                        </div>
                            <div className={`invalid-feedback ${rtl}`}>
                        ...
                        <button type="submit" className={`btn btn-success w-100 shadow btn-sm rounded ${rtl}`}>{t('register.btn_register')}</button>
                    </form>
                    ...
                    <p className={`text-center ${rtl}`}>{t('register.have_account_lft_text')} <strong className="text-danger">khati</strong> {t('register.have_account_rgt_text')} <Link to="/login">{t('register.btn_signin_text')}<i
